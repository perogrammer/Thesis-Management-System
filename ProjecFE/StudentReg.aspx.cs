        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string insertStudentQuery = "INSERT INTO Students (UserID) VALUES (@UserID);";
                    ...
                    int roleIdForStudent = GetRoleIdForRoleName(connection, studentRoleName);
                    ...
                    {
                        command.Parameters.AddWithValue("@UserID", userId);
                        command.Parameters.AddWithValue("@RoleID", roleIdForStudent);
