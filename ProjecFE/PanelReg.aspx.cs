...
namespace ProjecFE
{
    public partial class PanelReg : System.Web.UI.Page
    {
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string insertStudentQuery = "INSERT INTO PanelMembers (UserID) VALUES (@UserID);";
                    ...
                    string panelMemberRoleName = "Panel Member";
                    ...
                    Response.Write("<script>window.location.href='PanelMemeberLogin.aspx';</script>");
                }
            }
            catch (Exception ex)
            {
